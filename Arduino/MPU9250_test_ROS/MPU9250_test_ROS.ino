...
void loop()
{
  ...
  if (myIMU.delt_t > 10)
  {
    ...
    Serial.write((const uint8_t *)&myIMU.gx, sizeof(float));
    Serial.write((const uint8_t *)&myIMU.gy, sizeof(float));
    Serial.write((const uint8_t *)&myIMU.gz, sizeof(float));

    ////////////////////// Orientation ///////////////////////////
    Serial.write((const uint8_t *)&myIMU.mx, sizeof(float));
    Serial.write((const uint8_t *)&myIMU.my, sizeof(float));
    Serial.write((const uint8_t *)&myIMU.mz, sizeof(float));
